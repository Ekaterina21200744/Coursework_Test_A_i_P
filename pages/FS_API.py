...
class FS_API:
     ...
     def search_by_country(self, departureCityId, arrivalCountryId, minStartDate, maxStartDate, minNightsCount, maxNightsCount, adults):
          ...
          with allure.step("Выполнение GET-запроса к API с заданными параметрами и заголовками"):
               response = requests.get(self.url + "get-by-country", params=params, headers=headers)
               return response
...
class FS_API:
     ...
     def sort_ascending_price(self, departureCityId, arrivalCountryId, minStartDate, maxStartDate, minNightsCount, maxNightsCount, adults):
          ...
          with allure.step("Выполнение GET-запроса к API для получения отсортированных туров"):
               response_sorted = requests.get(self.url + "get-by-country",params=params_sorted_max, headers=headers)
               return response_sorted
          
     def sort_descending_pirce(self, departureCityId, arrivalCountryId, minStartDate, maxStartDate, minNightsCount, maxNightsCount, adults):
          ...
          with allure.step("Выполнение GET-запроса к API для получения отсортированных туров"):
               response_sorted = requests.get(self.url + "get-by-country",params=params_sorted_min, headers=headers)
               return response_sorted
          
     def search_tour_city_spase(self, departureCityId, arrivalCountryId, minStartDate, maxStartDate, minNightsCount, maxNightsCount, adults):
